...
if True:
    ...
    ax[0,0].plot(hex_for_L_50[:, 0], hex_for_L_50[:, 1], ">--", color="red", label=r"$J$, forward", markersize=marks)
    #ax[0,0].plot(hex_for_L_50[:, 0], hex_for_L_50[:, 3], "s", color="green", label=r"$M$, forward", markersize=marks)
    ax[0,0].plot(hex_back_L_50[:, 0], hex_back_L_50[:, 1], "*--", color="black", label=r"$J$, backward", markersize=marks)
    #ax[0,0].plot(hex_back_L_50[:, 0], hex_back_L_50[:, 3],  "o", color="red", label=r"$M$, backward", markersize=marks)
    ax[0,0].grid()
    ax[0,0].set_ylabel(r"$J,M$")
    ax[0,0].legend()

    ax[1,0].plot(hex_for_L_100[:, 0], hex_for_L_100[:, 1],  ">--", color="red", label=r"$J$, forward", markersize=marks)
    #ax[1,0].plot(hex_for_L_100[:, 0], hex_for_L_100[:, 3],  "s", color="green", label=r"$M$, forward", markersize=marks)
    ax[1,0].plot(hex_back_L_100[:, 0], hex_back_L_100[:, 1],  "*--", color="black", label=r"$J$, backward", markersize=marks)
    ...
    ax[0,1].plot(tri_for_L_50[:, 0], tri_for_L_50[:, 1],  ">--", color="red", label=r"$J$, forward", markersize=marks)
    #ax[0,1].plot(tri_for_L_50[:, 0], tri_for_L_50[:, 3],  "s", color="green", label=r"$M$, forward", markersize=marks)
    ax[0,1].plot(tri_back_L_50[:, 0], tri_back_L_50[:, 1],  "*--", color="black", label=r"$J$, backward", markersize=marks)
    #ax[0,1].plot(tri_back_L_50[:, 0], tri_back_L_50[:, 3],  "o", color="red", label=r"$M$, backward", markersize=marks)
    ax[0,1].grid()

    ax[1,1].plot(tri_for_L_100[:, 0], tri_for_L_100[:, 1],  ">--", color="red", label=r"$J$, forward", markersize=marks)
    #ax[1,1].plot(tri_for_L_100[:, 0], tri_for_L_100[:, 3],  "s", color="green", label=r"$M$, forward", markersize=marks)
    ax[1,1].plot(tri_back_L_100[:, 0], tri_back_L_100[:, 1],  "*--", color="black", label=r"$J$, backward", markersize=marks)
    ...
    ax[0,2].plot(squ_for_L_50[:, 0], squ_for_L_50[:, 1],  ">--", color="red", label=r"$J$, forward", markersize=marks)
    #ax[0,2].plot(squ_for_L_50[:, 0], squ_for_L_50[:, 3],  "s", color="green", label=r"$M$, forward", markersize=marks)
    ax[0,2].plot(squ_back_L_50[:, 0], squ_back_L_50[:, 1],  "*--", color="black", label=r"$J$, backward", markersize=marks)
    #ax[0,2].plot(squ_back_L_50[:, 0], squ_back_L_50[:, 3],  "o", color="red", label=r"$M$, backward", markersize=marks)
    ax[0,2].grid()

    ax[1,2].plot(squ_for_L_100[:, 0], squ_for_L_100[:, 1],  ">--", color="red", label=r"$J$, forward", markersize=marks)
    #ax[1,2].plot(squ_for_L_100[:, 0], squ_for_L_100[:, 3],  "s", color="green", label=r"$M$, forward", markersize=marks)
    ax[1,2].plot(squ_back_L_100[:, 0], squ_back_L_100[:, 1],  "*--", color="black", label=r"$J$, backward", markersize=marks)

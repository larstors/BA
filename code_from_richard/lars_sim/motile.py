...
if True:
    ...
    #plt.tight_layout()
    ax2 = ax[0,0].twinx()
    ax2.errorbar(data_squ_1[:, 0], data_squ_1[:, 5-2]*4700, yerr=np.sqrt(data_squ_1[:, 6-2])*4700*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax3 = ax[0,1].twinx()
    ax3.errorbar(data_squ_2[:, 0], data_squ_2[:, 5-2]*5500, yerr=np.sqrt(data_squ_2[:, 6-2])*5500*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax4 = ax[0,2].twinx()
    ax4.errorbar(data_squ_3[:, 0], data_squ_3[:, 5-2]*5800, yerr=np.sqrt(data_squ_3[:, 6-2])*5800*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax5 = ax[1,0].twinx()
    ax5.errorbar(data_hex_1[:, 0], data_hex_1[:, 5-2]*11000, yerr=np.sqrt(data_hex_1[:, 6-2])*11000*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax6 = ax[1,1].twinx()
    ax6.errorbar(data_hex_2[:, 0], data_hex_2[:, 5-2]*13200, yerr=np.sqrt(data_hex_2[:, 6-2])*13200*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax7 = ax[1,2].twinx()
    ax7.errorbar(data_hex_3[:, 0], data_hex_3[:, 5-2]*14100, yerr=np.sqrt(data_hex_3[:, 6-2])*14100*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax8 = ax[2,0].twinx()
    ax8.errorbar(data_tri_1[:, 0], data_tri_1[:, 5-2]*4000, yerr=np.sqrt(data_tri_1[:, 6-2])*4000*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax9 = ax[2,1].twinx()
    ax9.errorbar(data_tri_2[:, 0], data_tri_2[:, 5-2]*4500, yerr=np.sqrt(data_tri_2[:, 6-2])*4500*0, fmt="s", color="red", label=r"$NM, L=100$")
    ...
    ax21 = ax[2,2].twinx()
    ax21.errorbar(data_tri_3[:, 0], data_tri_3[:, 5-2]*4700, yerr=np.sqrt(data_tri_3[:, 6-2])*4700*0, fmt="s", color="red", label=r"$NM, L=100$")
...
ax[0,0].errorbar(hex_for_L_50[:, 0], hex_for_L_50[:, 1], yerr=np.sqrt(hex_for_L_50[:, 2]), fmt=">", color="red", label=r"$J$, forward")
ax[0,0].errorbar(hex_for_L_50[:, 0], hex_for_L_50[:, 3], yerr=np.sqrt(hex_for_L_50[:, 4]), fmt=">", color="blue", label=r"$M$, forward")
#ax[0,0].errorbar(hex_back_L_50[:, 0], hex_back_L_50[:, 1], yerr=np.sqrt(hex_back_L_50[:, 2]), fmt="<", color="red", label=r"$J$, backward")
#ax[0,0].errorbar(hex_back_L_50[:, 0], hex_back_L_50[:, 3], yerr=np.sqrt(hex_back_L_50[:, 4]), fmt="<", color="blue", label=r"$M$, backward")

#ax[1,0].errorbar(hex_for_L_100[:, 0], hex_for_L_100[:, 1], yerr=np.sqrt(hex_for_L_100[:, 2]), fmt=">", color="red", label=r"$J$, forward")
#ax[1,0].errorbar(hex_for_L_100[:, 0], hex_for_L_100[:, 3], yerr=np.sqrt(hex_for_L_100[:, 4]), fmt=">", color="blue", label=r"$M$, forward")
#ax[1,0].errorbar(hex_back_L_100[:, 0], hex_back_L_100[:, 1], yerr=np.sqrt(hex_back_L_100[:, 2]), fmt="<", color="red", label=r"$J$, backward")
#ax[1,0].errorbar(hex_back_L_100[:, 0], hex_back_L_100[:, 3], yerr=np.sqrt(hex_back_L_100[:, 4]), fmt="<", color="blue", label=r"$M$, backward")

ax[0,1].set_title("Tri")
ax[0,1].errorbar(tri_for_L_50[:, 0], tri_for_L_50[:, 1], yerr=np.sqrt(tri_for_L_50[:, 2]), fmt=">", color="red", label=r"$J$, forward")
ax[0,1].errorbar(tri_for_L_50[:, 0], tri_for_L_50[:, 3], yerr=np.sqrt(tri_for_L_50[:, 4]), fmt=">", color="blue", label=r"$M$, forward")
ax[0,1].errorbar(tri_back_L_50[:, 0], tri_back_L_50[:, 1], yerr=np.sqrt(tri_back_L_50[:, 2]), fmt="<", color="red", label=r"$J$, backward")
ax[0,1].errorbar(tri_back_L_50[:, 0], tri_back_L_50[:, 3], yerr=np.sqrt(tri_back_L_50[:, 4]), fmt="<", color="blue", label=r"$M$, backward")

#ax[1,1].errorbar(tri_for_L_100[:, 0], tri_for_L_100[:, 1], yerr=np.sqrt(tri_for_L_100[:, 2]), fmt=">", color="red", label=r"$J$, forward")
#ax[1,1].errorbar(tri_for_L_100[:, 0], tri_for_L_100[:, 3], yerr=np.sqrt(tri_for_L_100[:, 4]), fmt=">", color="blue", label=r"$M$, forward")
#ax[1,1].errorbar(tri_back_L_100[:, 0], tri_back_L_100[:, 1], yerr=np.sqrt(tri_back_L_100[:, 2]), fmt="<", color="red", label=r"$J$, backward")
#ax[1,1].errorbar(tri_back_L_100[:, 0], tri_back_L_100[:, 3], yerr=np.sqrt(tri_back_L_100[:, 4]), fmt="<", color="blue", label=r"$M$, backward")

ax[0,2].set_title("Squ")
ax[0,2].errorbar(squ_for_L_50[:, 0], squ_for_L_50[:, 1], yerr=np.sqrt(squ_for_L_50[:, 2]), fmt=">", color="red", label=r"$J$, forward")
ax[0,2].errorbar(squ_for_L_50[:, 0], squ_for_L_50[:, 3], yerr=np.sqrt(squ_for_L_50[:, 4]), fmt=">", color="blue", label=r"$M$, forward")
ax[0,2].errorbar(squ_back_L_50[:, 0], squ_back_L_50[:, 1], yerr=np.sqrt(squ_back_L_50[:, 2]), fmt="<", color="red", label=r"$J$, backward")
ax[0,2].errorbar(squ_back_L_50[:, 0], squ_back_L_50[:, 3], yerr=np.sqrt(squ_back_L_50[:, 4]), fmt="<", color="blue", label=r"$M$, backward")

#ax[1,2].errorbar(squ_for_L_100[:, 0], squ_for_L_100[:, 1], yerr=np.sqrt(squ_for_L_100[:, 2]), fmt=">", color="red", label=r"$J$, forward")
#ax[1,2].errorbar(squ_for_L_100[:, 0], squ_for_L_100[:, 3], yerr=np.sqrt(squ_for_L_100[:, 4]), fmt=">", color="blue", label=r"$M$, forward")
#ax[1,2].errorbar(squ_back_L_100[:, 0], squ_back_L_100[:, 1], yerr=np.sqrt(squ_back_L_100[:, 2]), fmt="<", color="red", label=r"$J$, backward")
#ax[1,2].errorbar(squ_back_L_100[:, 0], squ_back_L_100[:, 3], yerr=np.sqrt(squ_back_L_100[:, 4]), fmt="<", color="blue", label=r"$M$, backward")

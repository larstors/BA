...
# triangle
if lat == "t":
    n1 = ["tri_1_0.001.txt", "tri_1_0.005.txt",
          "tri_1_0.010.txt", "tri_1_0.050.txt", "tri_1_0.100.txt"]
    n2 = ["tri_2_0.001.txt", "tri_2_0.005.txt",
          "tri_2_0.010.txt", "tri_2_0.050.txt", "tri_2_0.100.txt"]
    n3 = ["tri_3_0.001.txt", "tri_3_0.005.txt",
          "tri_3_0.010.txt", "tri_3_0.050.txt", "tri_3_0.100.txt"]
    ...
    plt.plot(t, p(10, fit(np.log10(t), *par3)), "g--",
             label=r"$\sim \alpha^{%.2f}$" % par3[0])
    plt.plot(1/alp, p(10, np.array(Tstop[0])),
             "ro", label=r"$n_\mathrm{max}=1$")
    plt.plot(1/alp, p(10, np.array(Tstop[1])),
             "bo", label=r"$n_\mathrm{max}=2$")
    plt.plot(1/alp, p(10, np.array(Tstop[2])),
             "go", label=r"$n_\mathrm{max}=3$")
    # plt.legend()
    plt.ylabel(r"${T_\mathrm{stop}^\alpha}$")
...
if lat == "s":
    ...
    n1 = ["square_1_0.001.txt", "square_1_0.002.txt", "square_1_0.003.txt", "square_1_0.004.txt", "square_1_0.005.txt", "square_1_0.006.txt", "square_1_0.007.txt", "square_1_0.008.txt", "square_1_0.009.txt", "square_1_0.010.txt",
          "square_1_0.020.txt", "square_1_0.030.txt", "square_1_0.040.txt", "square_1_0.050.txt", "square_1_0.060.txt", "square_1_0.070.txt", "square_1_0.080.txt", "square_1_0.090.txt"]  # , "square_3_0.100.txt"]
    n2 = ["square_1_0.100.txt", "square_1_0.200.txt", "square_1_0.300.txt",
          "square_1_0.400.txt", "square_1_0.500.txt", "square_1_0.600.txt"]
    ...
    plt.plot(alp, np.array(Tstop[0]), "go", label=r"$n_\mathrm{max}=1$")
    ...
    plt.yscale("log")
    plt.xscale("log")
    plt.savefig("stop_squ_fit_1.pdf", dpi=150, bbox_inches="tight")

    # ################################################################ FOR n=2 ####################################################################

    n1 = ["square_2_0.001.txt", "square_2_0.002.txt", "square_2_0.003.txt", "square_2_0.004.txt", "square_2_0.005.txt", "square_2_0.006.txt", "square_2_0.007.txt", "square_2_0.008.txt", "square_2_0.009.txt", "square_2_0.010.txt",
          "square_2_0.020.txt", "square_2_0.030.txt", "square_2_0.040.txt", "square_2_0.050.txt", "square_2_0.060.txt", "square_2_0.070.txt", "square_2_0.080.txt", "square_2_0.090.txt"]  # , "square_3_0.100.txt"]
    n2 = ["square_2_0.100.txt", "square_2_0.200.txt", "square_2_0.300.txt",
          "square_2_0.400.txt", "square_2_0.500.txt", "square_2_0.600.txt"]
    alp2 = [0.100, 0.200, 0.100*3, 0.100*4, 0.100*5, 0.100*6]
    alp = [0.001 * i for i in range(1, 11)]
    for i in range(2, 10):
        alp.append(0.01*i)
    ...
    plt.yscale("log")
    plt.xscale("log")
    plt.savefig("stop_squ_fit_2.pdf", dpi=150, bbox_inches="tight")

    # ################################################################ FOR n=3 ####################################################################

    n1 = ["square_3_0.001.txt", "square_3_0.002.txt", "square_3_0.003.txt", "square_3_0.004.txt", "square_3_0.005.txt", "square_3_0.006.txt", "square_3_0.007.txt", "square_3_0.008.txt", "square_3_0.009.txt", "square_3_0.010.txt",
          "square_3_0.020.txt", "square_3_0.030.txt", "square_3_0.040.txt", "square_3_0.050.txt", "square_3_0.060.txt", "square_3_0.070.txt", "square_3_0.080.txt", "square_3_0.090.txt"]  # , "square_3_0.100.txt"]
    n2 = ["square_3_0.100.txt", "square_3_0.200.txt", "square_3_0.300.txt",
          "square_3_0.400.txt", "square_3_0.500.txt", "square_3_0.600.txt"]
    alp2 = [0.100, 0.200, 0.100*3, 0.100*4, 0.100*5, 0.100*6]
    alp = [0.001 * i for i in range(1, 11)]
    for i in range(2, 10):
        alp.append(0.01*i)
...
if lat == "h":
    ...
    n1 = ["hex_1_0.001.txt", "hex_1_0.002.txt", "hex_1_0.003.txt", "hex_1_0.004.txt", "hex_1_0.005.txt", "hex_1_0.006.txt", "hex_1_0.007.txt", "hex_1_0.008.txt", "hex_1_0.009.txt", "hex_1_0.010.txt",
          "hex_1_0.020.txt", "hex_1_0.030.txt", "hex_1_0.040.txt", "hex_1_0.050.txt", "hex_1_0.060.txt", "hex_1_0.070.txt", "hex_1_0.080.txt", "hex_1_0.090.txt"]  # , "hex_3_0.100.txt"]
    n2 = ["hex_1_0.100.txt", "hex_1_0.200.txt", "hex_1_0.300.txt",
          "hex_1_0.400.txt", "hex_1_0.500.txt", "hex_1_0.600.txt"]
    alp2 = [0.100, 0.200, 0.100*3, 0.100*4, 0.100*5, 0.100*6]
    alp = [0.001 * i for i in range(1, 11)]
    for i in range(2, 10):
        alp.append(0.01*i)
    ...
    plt.yscale("log")
    plt.xscale("log")
    plt.savefig("stop_hex_fit_1.pdf", dpi=150, bbox_inches="tight")
    """
    # ################################################################ FOR n=2 ####################################################################

    n1 = ["hex_2_0.001.txt", "hex_2_0.002.txt", "hex_2_0.003.txt", "hex_2_0.004.txt", "hex_2_0.005.txt", "hex_2_0.006.txt", "hex_2_0.007.txt", "hex_2_0.008.txt", "hex_2_0.009.txt", "hex_2_0.010.txt",
          "hex_2_0.020.txt", "hex_2_0.030.txt", "hex_2_0.040.txt", "hex_2_0.050.txt", "hex_2_0.060.txt", "hex_2_0.070.txt", "hex_2_0.080.txt", "hex_2_0.090.txt"]  # , "hex_3_0.100.txt"]
    n2 = ["hex_2_0.100.txt", "hex_2_0.200.txt", "hex_2_0.300.txt",
          "hex_2_0.400.txt", "hex_2_0.500.txt", "hex_2_0.600.txt"]
    alp2 = [0.100, 0.200, 0.100*3, 0.100*4, 0.100*5, 0.100*6]
    alp = [0.001 * i for i in range(1, 11)]
    for i in range(2, 10):
        alp.append(0.01*i)
    ...
    plt.yscale("log")
    plt.xscale("log")
    plt.savefig("stop_hex_fit_2.pdf", dpi=150, bbox_inches="tight")

    # ################################################################ FOR n=3 ####################################################################

    n1 = ["hex_3_0.001.txt", "hex_3_0.002.txt", "hex_3_0.003.txt", "hex_3_0.004.txt", "hex_3_0.005.txt", "hex_3_0.006.txt", "hex_3_0.007.txt", "hex_3_0.008.txt", "hex_3_0.009.txt", "hex_3_0.010.txt",
          "hex_3_0.020.txt", "hex_3_0.030.txt", "hex_3_0.040.txt", "hex_3_0.050.txt", "hex_3_0.060.txt", "hex_3_0.070.txt", "hex_3_0.080.txt", "hex_3_0.090.txt"]  # , "hex_3_0.100.txt"]
    n2 = ["hex_3_0.100.txt", "hex_3_0.200.txt", "hex_3_0.300.txt",
          "hex_3_0.400.txt", "hex_3_0.500.txt", "hex_3_0.600.txt"]
    alp2 = [0.100, 0.200, 0.100*3, 0.100*4, 0.100*5, 0.100*6]
    alp = [0.001 * i for i in range(1, 11)]
    for i in range(2, 10):
        alp.append(0.01*i)

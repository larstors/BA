...
if what == 1:
    ...
    for i in range(len(square_sv)):
        ax1.plot(square_sv[i][1::2], square_sv[i][::2], "ro")
    ...
    ax1.grid()
    ax1.legend()
    plt.savefig("sq_n_1_log.pdf", dpi=150)
    #plt.show()
    ...
    plt.tight_layout()
    for i in range(6):
        ax[i%3,i%2].scatter(x=conv(square_part[16*i][::2])[0], y=conv(square_part[16*i][::2])[1], marker="s", color="black", s=10)
        ax[i%3,i%2].set_xticks([])
        ax[i%3,i%2].set_yticks([])
...
if what == 2:
    ...
    plt.tight_layout()
    for i in range(6):
        ax[i%3,i%2].scatter(x=tri_conv(square_part[16*i][1::3])[0], y=tri_conv(square_part[16*i][1::3])[1], marker="s", color="black", s=1)
        ax[i%3,i%2].set_xticks([])
        ax[i%3,i%2].set_yticks([])
...
if what == 3:
    ...
    ax1.grid()
    ax1.legend()
    plt.savefig("hx_n_1.pdf", dpi=150)
    #plt.show()
    ...
    ax1.grid()
    ax1.legend()
    plt.savefig("hx_n_1_log.pdf", dpi=150)
    #plt.show()
    ...
    plt.tight_layout()
    for i in range(6):
        ax[i%3,i%2].scatter(x=conv(square_part[16*i][1::4], square_part[16*i][2::4])[0], y=conv(square_part[16*i][1::4], square_part[16*i][2::4])[1], marker="s", color="black", s=4)
        ax[i%3,i%2].set_xticks([])
        ax[i%3,i%2].set_yticks([])
    
    plt.savefig("snapshot_hx_n_1.pdf", dpi=200)
